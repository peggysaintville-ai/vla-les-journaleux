  ...
  try {
    ...
    if (!settings) {
      settings = await db.vitrineSettings.create({
        data: {
          ...
          heroPhotoPosition: DEFAULT_VITRINE_SETTINGS.heroPhotoPosition,
          ...
          donationEnabled: DEFAULT_VITRINE_SETTINGS.donationEnabled,
          donationTitle: DEFAULT_VITRINE_SETTINGS.donationTitle,
          donationSubtitle: DEFAULT_VITRINE_SETTINGS.donationSubtitle,
          donationDescription: DEFAULT_VITRINE_SETTINGS.donationDescription,
          donationUrl: DEFAULT_VITRINE_SETTINGS.donationUrl,
          donationButtonText: DEFAULT_VITRINE_SETTINGS.donationButtonText,
          donationImageUrl: DEFAULT_VITRINE_SETTINGS.donationImageUrl,
        },
      });
    }
    ...
    if (settings) {
      const res: VitrineSettingsData = {
        ...
        heroPhotoPosition: settings.heroPhotoPosition ?? DEFAULT_VITRINE_SETTINGS.heroPhotoPosition,
        ...
        donationEnabled: settings.donationEnabled ?? DEFAULT_VITRINE_SETTINGS.donationEnabled,
        donationTitle: settings.donationTitle ?? DEFAULT_VITRINE_SETTINGS.donationTitle,
        donationSubtitle: settings.donationSubtitle ?? DEFAULT_VITRINE_SETTINGS.donationSubtitle,
        donationDescription: settings.donationDescription ?? DEFAULT_VITRINE_SETTINGS.donationDescription,
        donationUrl: settings.donationUrl ?? DEFAULT_VITRINE_SETTINGS.donationUrl,
        donationButtonText: settings.donationButtonText ?? DEFAULT_VITRINE_SETTINGS.donationButtonText,
        donationImageUrl: settings.donationImageUrl ?? DEFAULT_VITRINE_SETTINGS.donationImageUrl,
    ...
    if (existing) {
      const updated = await db.vitrineSettings.update({
        ...
        data: {
          ...
          heroPhotoPosition: data.heroPhotoPosition !== undefined ? data.heroPhotoPosition : existing.heroPhotoPosition,
          ...
          donationEnabled: data.donationEnabled !== undefined ? data.donationEnabled : existing.donationEnabled,
          donationTitle: data.donationTitle !== undefined ? data.donationTitle : existing.donationTitle,
          donationSubtitle: data.donationSubtitle !== undefined ? data.donationSubtitle : existing.donationSubtitle,
          donationDescription: data.donationDescription !== undefined ? data.donationDescription : existing.donationDescription,
          donationUrl: data.donationUrl !== undefined ? data.donationUrl : existing.donationUrl,
          donationButtonText: data.donationButtonText !== undefined ? data.donationButtonText : existing.donationButtonText,
          donationImageUrl: data.donationImageUrl !== undefined ? data.donationImageUrl : existing.donationImageUrl,
        },
      });
      ...
      result = {
        ...
        heroPhotoPosition: updated.heroPhotoPosition,
        ...
        donationEnabled: updated.donationEnabled,
        donationTitle: updated.donationTitle,
        donationSubtitle: updated.donationSubtitle,
        donationDescription: updated.donationDescription,
        donationUrl: updated.donationUrl,
        donationButtonText: updated.donationButtonText,
        donationImageUrl: updated.donationImageUrl,
      ...
      const created = await db.vitrineSettings.create({
        data: {
          ...
          heroPhotoPosition: data.heroPhotoPosition ?? DEFAULT_VITRINE_SETTINGS.heroPhotoPosition,
          ...
          donationEnabled: data.donationEnabled ?? DEFAULT_VITRINE_SETTINGS.donationEnabled,
          donationTitle: data.donationTitle ?? DEFAULT_VITRINE_SETTINGS.donationTitle,
          donationSubtitle: data.donationSubtitle ?? DEFAULT_VITRINE_SETTINGS.donationSubtitle,
          donationDescription: data.donationDescription ?? DEFAULT_VITRINE_SETTINGS.donationDescription,
          donationUrl: data.donationUrl ?? DEFAULT_VITRINE_SETTINGS.donationUrl,
          donationButtonText: data.donationButtonText ?? DEFAULT_VITRINE_SETTINGS.donationButtonText,
          donationImageUrl: data.donationImageUrl ?? DEFAULT_VITRINE_SETTINGS.donationImageUrl,
        },
      });
      ...
      result = {
        ...
        heroPhotoPosition: created.heroPhotoPosition,
        ...
        donationEnabled: created.donationEnabled,
        donationTitle: created.donationTitle,
        donationSubtitle: created.donationSubtitle,
        donationDescription: created.donationDescription,
        donationUrl: created.donationUrl,
        donationButtonText: created.donationButtonText,
        donationImageUrl: created.donationImageUrl,
